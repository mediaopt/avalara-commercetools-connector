...
const AvalaraOriginAddress = ({ values, handleChange }: AvaTaxSettingsType) => {
  ...
  const checkAddress = async (values: SettingsFormDataType) => {
    ...
    const response = await fetch(url + "/check-address", { method: 'post', headers: {
    ...
    if (response?.valid) {
      ...
      const suggestedAddress = suggested.map((x) =>` ${x.name}: ${response?.address[0][x.key]},`)
      .reduce((acc, curr) => acc + curr, '')
      .slice(0, -1);
      showNotification({
        kind: NOTIFICATION_KINDS_PAGE.success,
        domain: DOMAINS.GLOBAL,
        text: 'Your origin address is valid!' + `${(suggested.length!==0)? ` Suggested address changes:${suggestedAddress}`: ''}`,
      });
      ...
      showNotification({
        ...
        domain: DOMAINS.GLOBAL,
        text: response?.errorMessage || "Internal server error.",
      });
    }
  }
  return (
      ...
      <Spacings.Inset scale="m">
        <Spacings.Stack alignItems="stretch" scale="m">
          ...
          <Spacings.Stack scale="m" alignItems="stretch">
            ...
            >
              <TextInput id='line1' value={values.line1} onChange={handleChange}></TextInput>
            ...
            <Spacings.Inline
              ...
              justifyContent="flex-start"
            >
              <TextInput id='line2' value={values.line2} onChange={handleChange}></TextInput>
            ...
            <Spacings.Inline
              ...
              justifyContent="flex-start"
            >
              <TextInput id='line3' value={values.line3} onChange={handleChange}></TextInput>
            ...
            justifyContent="flex-start"
            >
            <TextInput id='postalCode' value={values.postalCode} onChange={handleChange}></TextInput>
            ...
            justifyContent="flex-start"
            >
            <TextInput id='city' value={values.city} onChange={handleChange}></TextInput>
            ...
            justifyContent="flex-start"
            >
            <TextInput id='region' value={values.region} onChange={handleChange}></TextInput>
            ...
            justifyContent="flex-start"
            >
            <TextInput id='country' value={values.country} onChange={handleChange}></TextInput>
            ...
            <Spacings.Inline
              ...
              justifyContent="flex-start"
            >
              <PrimaryButton label="Check address" onClick={() => checkAddress(values)} />
            </Spacings.Inline>
