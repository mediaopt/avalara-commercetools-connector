...
import { getData, getShipTaxCode, getCustomerEntityUseCode, getBulkCategoryTaxCode, getBulkProductCategories } from '../src/client/create.client';
...
describe('Entity use code can be loaded', () => {
    test('Data exists and is defined', async () => {
        const data = await getCustomerEntityUseCode('57340918-98ce-493e-8dbd-eea993a1ab26')
        expect(typeof data).toBe('string')
    })
  })
...
describe('Categories tax codes can be bulk loaded', () => {
    test('Data exists and is defined', async () => {
        const data = await getBulkCategoryTaxCode(['724782b3-d2c1-40ed-b757-c5c3671aeefb', '23139051-4054-4a56-bb13-f0614b0aaec9'])
        expect(data).toBeDefined();
